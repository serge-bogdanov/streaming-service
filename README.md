...
- **Minista Sprite** - optimized SVG icon system
...
Open the local development server and explore the interface. To create a production build:
...
Created by [Serge Bogdanov](https://github.com/serge-bogdanov).

[View the live project](https://serge-bogdanov.github.io/streaming-service/) · [View the source code](https://github.com/serge-bogdanov/streaming-service)
